...
license_key_pd = 'NN5d6uJtRxgOJqVmnwtujhi1v2JGWSvBpkwFjoKgUnE' # Parallel Dots 6
...
def api_calls(text):
    ...
    emotion_dict = {
        ...
        'excited' : emotion_response['emotion']['Excited']  
    }
...
def extract_data():
    with open('Training492.csv') as csv_file: 
        ...
        with open('output.csv','w') as file: 
            fieldnames = ['ID', 'Text', 'Class', 'score_tag', 'agreement', 'subjectivity', 'confidence', 'irony', 'happy', 'angry', 'bored', 'fear', 'sad', 'excited']
